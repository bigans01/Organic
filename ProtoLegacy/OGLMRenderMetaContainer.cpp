...
void OGLMRenderMetaContainer::createContainerArrays(int T1_inCubesize, int T2_inCubesize)
{
	...
	T1_renderMetaContainerArray.reset(new OGLMRenderMetaContainerElementT1[T1_inCubesize*T1_inCubesize*T1_inCubesize]);
	T2_renderMetaContainerArray.reset(new OGLMRenderMetaContainerElementT2[T2_inCubesize*T2_inCubesize*T2_inCubesize]);
